...
namespace App\Filament\Resources\RebateTrackerResource\RelationManagers;
...
class ActivitiesRelationManager extends RelationManager
{
    ...
    // Đổi tên Tab hiển thị dưới form Edit
    protected static ?string $title = 'Operation history';
