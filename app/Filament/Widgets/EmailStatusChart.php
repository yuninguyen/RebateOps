...
class EmailStatusChart extends ChartWidget
{
    ...
    // Giới hạn chiều cao biểu đồ cho đẹp
            ...
            <div style='display: flex; gap: 12px; align-items: center;'>
                <div style='display: flex; flex-direction: column; gap: 2px;'>
                    <div style='display: flex; align-items: center; gap: 6px;'>
                        ...
                        <span style='font-size: 11px; font-weight: 600; color: #4BC0C0; text-transform: uppercase; letter-spacing: 0.05em;'>Live</span>
                    </div>
                ...
                <div style='display: flex; flex-direction: column; gap: 2px;'>
                    <div style='display: flex; align-items: center; gap: 6px;'>
                        ...
                        <span style='font-size: 11px; font-weight: 600; color: #FF6384; text-transform: uppercase; letter-spacing: 0.05em;'>Locked</span>
                    </div>
                ...
                <div style='display: flex; flex-direction: column; gap: 2px;'>
                    <div style='display: flex; align-items: center; gap: 6px;'>
                        ...
                        <span style='font-size: 11px; font-weight: 600; color: #FF9F40; text-transform: uppercase; letter-spacing: 0.05em;'>Disabled</span>
                    </div>
